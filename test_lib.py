...
#we can be sure the calc_desc_stat function is working
#properly since it passes multiple cases.
#below we calculate the mean, std, and quantile of 25%
#by hand to confirm the pandas function calc desc stat is working right
